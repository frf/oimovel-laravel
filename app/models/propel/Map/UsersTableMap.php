...
class UsersTableMap extends TableMap
{
     ...
     */
    const COL_TIME_CREATED = 'users.time_created';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('TimeCreated', 'Name', 'Roles', 'Salt', 'Password', 'Email', 'Id', ),
        self::TYPE_CAMELNAME     => array('timeCreated', 'name', 'roles', 'salt', 'password', 'email', 'id', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_TIME_CREATED, UsersTableMap::COL_NAME, UsersTableMap::COL_ROLES, UsersTableMap::COL_SALT, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_EMAIL, UsersTableMap::COL_ID, ),
        self::TYPE_FIELDNAME     => array('time_created', 'name', 'roles', 'salt', 'password', 'email', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('TimeCreated' => 0, 'Name' => 1, 'Roles' => 2, 'Salt' => 3, 'Password' => 4, 'Email' => 5, 'Id' => 6, ),
        self::TYPE_CAMELNAME     => array('timeCreated' => 0, 'name' => 1, 'roles' => 2, 'salt' => 3, 'password' => 4, 'email' => 5, 'id' => 6, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_TIME_CREATED => 0, UsersTableMap::COL_NAME => 1, UsersTableMap::COL_ROLES => 2, UsersTableMap::COL_SALT => 3, UsersTableMap::COL_PASSWORD => 4, UsersTableMap::COL_EMAIL => 5, UsersTableMap::COL_ID => 6, ),
        self::TYPE_FIELDNAME     => array('time_created' => 0, 'name' => 1, 'roles' => 2, 'salt' => 3, 'password' => 4, 'email' => 5, 'id' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('roles', 'Roles', 'VARCHAR', true, 255, '');
        $this->addColumn('salt', 'Salt', 'VARCHAR', true, 255, '');
    ...
    {
        $this->addRelation('UserCustomFields', '\\UserCustomFields', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null, 'UserCustomFieldss');
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UsersTableMap::COL_TIME_CREATED);
            $criteria->addSelectColumn(UsersTableMap::COL_NAME);
            $criteria->addSelectColumn(UsersTableMap::COL_ROLES);
